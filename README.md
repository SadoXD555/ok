...
_G.Color = Color3.fromRGB(255, 255, 255) ---Color

local Star = StarHub:Window("BloxFruits")

local StarServer = Star:Server("ok hub",8521503225) --ใส่idรูปได้
...
local AutoFarm = StarServer:Channel("Main")

AutoFarm:Toggle("Auto Farm Level", false, function(t)
    _G.AutoFarm = t
end)

AutoFarm:Toggle("Bring Mob", false, function(t)
    _G.BringMob = t
end)
...
local WE = AutoFarm:Dropdown("Select Weapon",Weapon,function(t)
    _G.SelectWeapon = t
end)
